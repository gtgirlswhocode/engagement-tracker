...
.html(function(d) {
    ...
    return "<h5>"+d['event_name']+"</h5><table><thead><tr><td>date</td><td>num_attendees</td><td>event_name</td><td>incentive</td></tr></thead>"
         + "<tbody><tr><td>"+(dateFormat(d['date']))+"</td><td>"+d['num_attendees']+"</td><td>"+d['event_name']+"</td><td>"+d['incentive']+"</td></tr></tbody></table>";
});
